...
[MISSING_DOC] El README no dice qué hacer si el puerto 3001 ya está siendo usado. Si el new hire tiene otro servicio corriendo, el servidor falla al iniciar y no sabe cómo solucionarlo.
